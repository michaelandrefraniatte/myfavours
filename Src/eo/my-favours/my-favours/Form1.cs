...
namespace my_favours
{
    public partial class Form1 : Form
    {
        ...
        {
            if (e.NewUrl.StartsWith("https://www.youtube.com/watch?v=") | !e.NewUrl.Contains("youtube.com"))
            {
                Process.Start(e.NewUrl);
                e.Cancel = true;
            }
            else if (!(e.NewUrl.StartsWith("https://www.youtube.com/feed/subscriptions") | e.NewUrl.StartsWith("https://www.youtube.com/embed/")))
                e.Cancel = true;
        }
...
".Replace("\r\n", " ").Replace("background.jpg", backgroundpath);
            ...
            this.webView1.EvalScript(stringinject);
            stringinject = @"var script = document.createElement('script'); script.src = 'https://www.youtube.com/iframe_api'; document.head.appendChild(script);";
            this.webView1.EvalScript(stringinject);
            stringinject = @"
